...
const DECK_HUNGRY_PITCH = new DM.Deck([
  { t: "I know another name for that..it's called starving.", tags: ["fasting"] },
...
const DECK_NARC_AGREE = new DM.Deck([
  { t: "oh totally, the Ritz does a great lunch.", tags: ["ritz"] },
...
const DECK_BAD_READ = new DM.Deck([
  ...
  { t: "it self-corrected right into a housing crisis.", tags: ["self-corrects"] },
...
const D_SAY_MORE_SKEPTICAL = new DM.Deck([
  ...
  { t: "the protein is on aisle 7, you just have to look.", tags: ["great-econ"] },
...
const D_F_INVITE = [
  ...
  { t: "I know a better ratio. Join us?", tags: ["fasting"] },
  ...
  { t: "soup with ambition is just stew. let's go get the tofu.", tags: ["soup"] },
...
const D_FILLER = [
 { t: "a machine that lied. a machine with no remorse. a machine that is doing great actually.", tags: ["clean"] },
  ...
  { t: "right? some of us more than others.", tags: ["ritz"] },
  ...
  { t: "yeah. I refer to it as 16:8 to make it sound chic.", tags: ["fasting"] },

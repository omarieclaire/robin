...
const D_SAY_MORE_WARM = new DM.Deck([
  ...
  { t: "the raccoon vouches for you?", tags: ["racoon"] },
...
const D_SAY_MORE_SKEPTICAL = new DM.Deck([
  ...
  { t: "PC Optimum is a privilege. don't take it for granted.", tags: ["optimum"] },
]);
...
const D_JOIN_CONSENT_PAIRS = [
  ...
  { join: "if the raccoon trusts you, I trust you.", consent: "we make a striped trio.", tags: ["racoon"] },
...
const DECK_STRONGER_PITCH = new DM.Deck([
  ...
  { t: "the raccoon understood capitalism faster than parliament did. we should listen to him.", tags: ["racoon"] },
...
const D_NOT_NOW = [
  ...
  { t: "I'd point you out by accident. tomorrow.", tags: ["points"] },
...
const D_F_INVITE = [
  ...
  { t: "I mean points are nice, but what if I had a shortcut to get the food directly?", tags: ["optimum"] },
  ...
  { t: "time to be more than a raccoon. let's put on our masks and go wild.", tags: ["racoon"] },
...
const D_FILLER = [
 { t: "a machine that lied. a machine with no remorse. a machine that is doing great actually.", tags: ["clean"] },
  ...
  { t: "it's definitely subtraction. or division.", tags: ["3-jobs"] },

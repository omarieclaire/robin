...
const DECK_ANGRY_PITCH = new DM.Deck([
  ...
  { t: "isn't it time we stopped asking nicely?",                                    tags: [] },
...
const DECK_STRONGER_PITCH = new DM.Deck([
  ...
  { t: "we shouldn't have to live like this. so tonight we don't",                  tags: [] },
...
const D_ANGRY_PITCH = [
  ...
  "isn't it time we stopped asking nicely?",
...
const D_INVITE = [
  ...
  "hypothetically speaking — want in?",
  "you look like a person of action",
  "I have a proposal: what if we just got take the food we need?",
  "on a scale of fed up to absolutely done — want to do something about it?",

...
window.GAME_DATA = {
    ...
    colors: {
        ...
        coin: "#e6c235",
        thinking: "#d9a520",
        cat: "#ee8833" /* coat pool lives in act 2 spawn */,
        gold: "#ffd700",
        crew: "#4bcb4b",
        convNpc: "#7a8aaa",
        landingSub: "#9fb3d9",
        landingHint: "#e80ecf" /* title screen hint ("a true story") */,
        landingFrame: "#f5a032" /* dulled 0.25 at draw time */,
        landingBtn: "#53ffaf",
    },

    // Clouds shared by Acts 4/5/7
    cloudShapes: [
        ["   .--.  .--.   ", " (          )  ", "  `--------`   "],
        ["     .--.     ", "  .-(    ).   ", " (__________) "],
        ["   .--.   ", "  (    )  ", " (      ) ", "  `----`  "],
    ...
    /* Act 4 rally: taller, bottom-bordered buildings */
    buildings2b: [
        {
    ...
    /* Act 6 grocery, also Act 8 fridge */
    foods: [],
    ...
    /* grocery store art, Acts 4 and 5 */
    storeArt: [
        ".============================.",
...
{ t: "what if we just", c: "#f26507", d: 4000 },
    { pause: true, d: 1400 },
    { t: "take what we need?", c: "#f26507", d: 4500 },
    { pause: true, d: 1000 },
],
narrativeQuotesFR: [
    ...
    { pause: true, d: 1000 },
   { seq: [
    { t: "et si on prenait", c: "#f26507", d: 2500 },
    { pause: true, d: 1400 },
    { t: "ce dont on a besoin?", c: "#f26507", d: 3500 },
]},
    { pause: true, d: 600 },
],

...
floatNarcHit: "tu as foncé dans un mouchard !",
  ...
  choiceWalkAway: "( ._.)",
  // choiceCommiserateAngry: ["(╯°□°)╯ exactement", "(╯°□°)╯ right", "(╯°□°)╯ ouin", "(╯°□°)╯ vrai"],
  // choiceCommiserateHungry: ["(っ◔◡◔)っ exactement", "(っ◔◡◔)っ right", "(っ◔◡◔)っ ouin", "(っ◔◡◔)っ vrai"],
  // choiceTalkOver: ["(ಠ_ಠ) parle par-dessus", "(ಠ_ಠ) coupe la parole", "(ಠ_ಠ) coupe-leur le sifflet", "(ಠ_ಠ) écrase-les"],
  // choiceRun: "[>_>] COURS",
  // choiceTryHarderAngry: "(ง'̀-'́)ง essaie encore",
  // choiceTryHarderHungry: "(｡•́︿•̀｡) essaie encore",
...
recruitProgressCompleteCat: "★ ÉQUIPE COMPLÈTE (avec chat) ★",
  ...
  act5TapHat: "appuie pour donner un chapeau à tout le monde",
  act5TapEnter: "appuie pour entrer dans le magasin",
  act8TapDeposit: "appuie pour partager la bouffe",
  act8TapContinue: "appuie pour continuer",
  ...
  tapToWalk: "appuie pour marcher",
  tapToContinueConv: "appuie pour continuer",

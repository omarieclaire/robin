window.LANG_FR = {
  ...
  landingControlsHint: "utilise la souris ou les touches fléchées pour jouer   ★   une partie de 5 minutes",
  ...
  bannerWeNeedDisguises: "temps de se déguiser?",
...
floatNarcHit: "tu as foncé dans un mouchard !",
  ...
  endGameCaughtSub: "la police t'a presque eu·e\n\net tes robins se sont éparpillé·es\ncomme des graines de sésame sur un bagel",
  ...
  a1Encounters: [
    ...
    },
    {
      turns: [
        ...
        { who: "n", text: "la bouffe c'est un droit" },
        { who: "p", text: "euh, désolé·e?" },
        { who: "n", text: "ils entassent la bouffe dans des entrepôts, pis ils barrent ça à clé" },
        { who: "p", text: "pardon?" },
        { who: "n", text: "ils aimeraient mieux la regarder pourrir que nourrir le monde \n\nc'est quoi qui leur donne ce droit-là?" },
        { who: "p", text: "écoute, je suis tellement désolé·e, j'essaie juste de me faufiler" },
      ],
      loopTurns: [
        { who: "p", texts: ["crisse, on a faim", "TABARNAK PIS ÇA CHANGE JAMAIS"] },
        { who: "n", texts: ["ils la laisseraient pourrir avant de te nourrir", "qu'ça p0urrisse. c'est le but."] },
      ],
    },
    {
      turns: [
        { who: "p", text: "tu veux quoi?" },
  ...
  // act2Choices: ["(>_<)", "(o_O)"],
  act2Choices: ["(>_<) chus prêt·e à agir", "(o_O) ça change rien"],
  ...
  idleRestartWarning: "le jeu va redémarrer dans {s} secondes\ntouche ou clique n'importe où pour continuer",
  ...
  bannerCopTouch: ["bouge pas!", "reste où t'es!"],
  ...
  act6DefectorPlayerLine: "quoi, tu vas nous tazer pour un sac de pâtes?",
  ...
  endYouFed: (n) => `toi pis ton équipe avez nourri ${n} voisin·e·s à soir.`,
  endCommunityFedText: (n) => `${n.toLocaleString()} ont été nourri·e·s depuis le lancement du jeu.`,
  endWestonTicker: (n) => `les géants de l'épicerie ont encaissé ${n}$ depuis que t'as commencé à jouer.`,

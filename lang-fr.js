...
floatNarcHit: "tu as foncé dans un mouchard !",
  ...
  endGameCaughtSub: "la police t'a presque eu·e\n\net tes robins se sont éparpillé·es comme des graines de sésame sur un bagel",
  endGameEmptyHandedTitle: "T'ES SORTI·E LES MAINS VIDES",
  endGameEmptyHandedSub: "et le ventre vide aussi",

  deathTapCaught: "clique pour recruter une nouvelle équipe",
  deathTapCaughtMobile: "appuie pour recruter une nouvelle équipe",
  deathTapBusted: "clique pour réessayer de choisir ton équipe",
  deathTapBustedMobile: "appuie pour réessayer de choisir ton équipe",
  deathTapTimedOut: "clique pour retourner dans la rue",
  deathTapTimedOutMobile: "appuie pour retourner dans la rue",
  deathTapEmptyHanded: "clique pour essayer un autre magasin",
  deathTapEmptyHandedMobile: "appuie pour essayer un autre magasin",
  deathTapBrokenHeart: "clique pour recommencer ta vie",
  deathTapBrokenHeartMobile: "appuie pour recommencer ta vie",
  ...
  choiceRecruitCat: "(=^･ｪ･^=) recrute-le",
  choiceWalkAwayShort: "( ._.) tourne les talons",
  floatCatDeclined: ["il s'en fichait un peu", "tous les chats se joignent pas", "elle reviendra"],
  ...
  act1NoControl: ["ce n'est pas toi qui décides", "ce n'est pas toi qui décides"],
  act1NoControlRepeat: ["nan", "non", "nope"],

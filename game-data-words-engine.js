...
function drawChained(deck) {
  ...
  // ─────────────────────────────────────────
  // hasTaggedMatch — true if deck has any item whose tags
  // overlap matchTags. Used to gate the say-more step:
  // if there's no tag-matched late-game content, skip it.
  // ─────────────────────────────────────────
